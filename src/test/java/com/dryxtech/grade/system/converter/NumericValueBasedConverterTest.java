...
class NumericValueBasedConverterTest {
    ...
    void setUp() throws IOException {
        ...
        converter = new NumericValueBasedConverter(registry);
    ...
    void convert() {
        ...
        GradeValue originalValue = new BasicGradeValue(new BigDecimal(100), "A", fromSystem.getId());
        GradeValue convertedValue = assertDoesNotThrow(() -> converter.convert(originalValue, toSystem.getId()));

        assertEquals("A+", convertedValue.getTextValue());
    }
}
